...
const DropdownMessage = () => {
  ...
  return (
    <li className="relative">
      <span
        className={`absolute -right-0.5 -top-0.5 z-1 h-2 w-2 rounded-full bg-red-400 ${
      ...
      <div
        ...
        className={`absolute -right-16 mt-2.5 flex h-96 w-72 flex-col rounded-sm border border-stroke  shadow dark:border-neutral-800 dark:bg-neutral-900  bg-white sm:right-0 sm:w-80 ${
